...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TestWorkForTPE", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TestWorkForTPE", null, 400, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TestWorkForTPE";
		app.meta["name"] = "TestWorkForTPE";
		app.meta["packageName"] = "com.sample.testworkfortpe";
